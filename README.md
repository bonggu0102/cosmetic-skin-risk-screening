...
- **신제품 개발 지원:** 제품 개발 단계에서 후보 전성분과 제품명을 입력해 피부유형별 부정 경험 위험을 비교하고, 추가 검토가 필요한 처방을 미리 선별하는 도구로 발전시킬 수 있습니다.
- **데이터 기반 모델 개선:** 신제품 출시 후 수집되는 실제 리뷰를 기존 데이터에 추가해 예측 결과를 검증하고, 새로운 성분과 소비자 반응을 반영하도록 모델을 주기적으로 재학습할 수 있습니다.
- **분석 범위 확장:** 현재의 크림 제품을 토너·세럼·선케어 등 다른 화장품군과 여러 판매 플랫폼으로 확대해 제품군별 위험 예측 모델을 구축할 수 있습니다.
- **서비스화:** 전성분을 입력하면 피부유형별 위험 순위와 관련 성분 정보를 보여주는 대시보드 형태로 구현해 제품 기획·연구개발 단계의 참고자료로 활용할 수 있습니다.

장기적으로는 출시 전 정보와 출시 후 리뷰가 이어지는 데이터 구조를 만들어, 신제품이 추가될수록 예측 결과가 개선되는 사전 검토 시스템으로 확장하는 것이 목표입니다.
