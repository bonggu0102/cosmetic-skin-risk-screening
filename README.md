...
| 항목 | 내용 |
|---|---|
| 원본 수집 데이터 | 올리브영 크림 240개 상품·전성분, 리뷰 57,903건 |
| 감성분석 완료 데이터 | 중복·애매·배송 리뷰 제외 후 47,487건 |
| Feature Engineering | 전성분이 확보된 231개 상품 |
| 최종 분석 대상 | 206개 상품, 1,124개 `제품 × 피부유형` 조합 |
| 예측 목표 | 피부유형별 부정 경험 고위험군 선별 |
| 입력 변수 | 피부유형, 전성분, 성분 기능·조합, 제품명 강조 문구 |
...
| 팀원           | 역할                                                                    |
| ------------ | --------------------------------------------------------------------- |
| **김서영 (팀장)** | 프로젝트 전반적인 방향 설정 및 총괄, Feature Engineering V2·V3·V4, 머신러닝 모델 최종 데이터 산출 |
| **최유선**      | 프로젝트 주제 아이디어 제안, Feature Engineering V1·V2·V5                         |
| **김찬결**      | 리뷰-소비자 관계 관련 논문 분석, 머신러닝 모델링                                          |
| **김민재**      | 올리브영 크림 화장품 데이터 크롤링, 리뷰 데이터 감성분석, 머신러닝 모델링                            |
...
| V3 | 성분 기능군 | 전성분을 보습·진정·장벽 등 기능군에 매핑해 제품별 성분 수를 집계 | 13 |
| V4 | 피부유형별 성분 조합 | 전성분 순서와 V3 기능군을 피부유형별 문헌 기반 규칙으로 조합 | 32 |
| V5 | 제품명 강조 문구 | 제품명에서 수분·진정·피지·모공·탄력 등 효능 및 사용 목적 관련 키워드를 추출 | 8 |
